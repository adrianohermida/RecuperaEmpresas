...
// api/[[slug]].js
var DEFAULT_LEGACY_API_BASE = "https://api.recuperaempresas.com.br";
var DEFAULT_WORKER_API_BASE = "https://api-edge.recuperaempresas.com.br";
var DEFAULT_WORKER_ROUTES = [
  "/api/auth",
  "/api/admin/clients",
  "/api/admin/client/*",
...
__name(matchesWorkerRoute, "matchesWorkerRoute");
...
__name(resolveTargetBase, "resolveTargetBase");
...
// ../.wrangler/tmp/pages-AGNtU5/functionsRoutes-0.535164143183163.mjs
var routes = [
  {
    routePath: "/api/:slug*",
    mountPath: "/api",
...
// C:/Users/ADRIANO/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/ADRIANO/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
